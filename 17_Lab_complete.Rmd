...
rf_model <- train(
  ...
  data= model_df,
  method = "rf",
  trControl = trainControl(method = "cv", number = 15) #cv means cross validated, number is the number of folds
)
...
It looks like the 2022 outlier data is really affecting our results. Go back in your code (17.9 Model Inputs) and filter out water year 2022 in model_df. Now rerun the code below and examine your model. Does your new number make more sense?
